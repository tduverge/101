...
#                                                  #+#   #+    #+    #+#       #
#    Created: 2018/04/23 15:42:17 by tduverge     #+#   ##    ##    #+#        #
#    Updated: 2018/04/23 16:11:25 by tduverge    ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
$(MINILIBX):
	...
	@echo "\033[32mminilibx created.\033[0m"

$(LIBFT):
	@make -C libft/

$(PSHSWP): $(PSHSWP_OBJ) $(LIBFT)
	@$(CC) $(FLAGS) $(PSHSWP_OBJ) $(LIBFT) -o $(PSHSWP)
	@echo "\033[32mpush_swap created.\033[0m"

$(CHECKR): $(CHECKR_OBJ) $(LIBFT) $(MINILIBX)
